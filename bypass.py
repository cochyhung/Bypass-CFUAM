...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r "+"[*]"+" Attack status => " + str((until - datetime.datetime.now()).total_seconds()) + " sec left ")
        else:
            stdout.flush()
            stdout.write("\r "+"[*]"+" Attack Done |                                                           \n")
            return
...
if __name__ == '__main__':
        ...
        stdout.write(" [*] "+"Bypassing CF... (Max 60s)\n")
        if get_cookie(target):
            ...
            stdout.write(" [*] "+"Failed to bypass cf\n")